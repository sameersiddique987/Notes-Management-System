...
const Notes = () => {
  ...
  const fetchNotes = async () => {
    ...
    try {
      ...
      const response = await fetch('https://notes-management-system-backend.vercel.app/api/notes/get', {
  ...
  const handleDelete = async (noteId) => {
    ...
    try {
      const response = await fetch(`https://notes-management-system-backend.vercel.app/api/notes/${noteId}`, {
        method: 'DELETE',
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const saveEditedNote = async () => {
    ...
    try {
      const response = await fetch(`https://notes-management-system-backend.vercel.app/api/notes/${editingNote._id}`, {
        method: 'PUT',
        headers: {
  ...
  const openVersionModal = async (noteId) => {
    ...
    try {
      ...
      const response = await fetch(`https://notes-management-system-backend.vercel.app/api/notes/${noteId}/versions`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleRollbackVersion = async (noteId, versionIndex) => {
    ...
    try {
      const response = await fetch(`https://notes-management-system-backend.vercel.app/api/notes/${noteId}/rollback`, {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'application/json',
