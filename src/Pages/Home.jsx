  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="bg-white shadow-lg rounded-xl w-full max-w-xl p-8">
        <h2 className="text-3xl font-bold text-center text-green-700 mb-6">Create New Note</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          {/* Visibility Field */}
          <div>
            <label className="block text-gray-700 font-semibold mb-1">Visibility</label>
            <select
            ...
            {errors.visibility && <p className="text-red-500 text-sm">Visibility is required</p>}
          </div>
